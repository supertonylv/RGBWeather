...
class IndicatorView : LinearLayout {
    ...
    lateinit var indicatorStrings: Array<String>
    lateinit var indicatorColorIds: IntArray
...
//        this.context = context
    ...
    private fun fillViewToParent(context: Context) {
        ...
        for (i in 0..(indicatorStrings.size - 1)) {
            addTextView(context, indicatorStrings.get(i), indicatorColorIds.get(i))
    ...
    private fun addTextView(context: Context, text: String?, color: Int?) {
        ...
        textView.setBackgroundColor(color ?: android.R.color.holo_blue_bright)
        textView.text = text
    ...
    var indicatorValueChangeListener1: IndicatorValueChangeListener? = null
//        get() = indicatorValueChangeListener
//        set(value) {
//            indicatorValueChangeListener = value
//        }

    fun setIndicatorValueChangeListener(indicatorValueChangeListener: IndicatorValueChangeListener) {
        this.indicatorValueChangeListener1 = indicatorValueChangeListener
    }
    ...
    fun setIndicatorValue(indicatorValue: Int) {
        ...
        if (indicatorValueChangeListener1 != null) {
            ...
            indicatorValueChangeListener1?.onChange(this.indicatorValue, stateDescription, indicatorTextColor)
        }
        invalidate()
    }
